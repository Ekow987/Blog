...
import First_img from '../img/mov6.jpg';
import Second_img from '../img/mov7.jpg';
import Nine_img from '../img/mov9.png';

function ImgCard() {
    return (
        <div>
        <CardGroup className="cone1">
  <Card>
    ...
    <Card.Body>
      ...
      Moviemaking is magic, and a legendary location adds a sprinkle of stardust. 
       ...
       <p><Link to="Readmore.js">[Read More]</Link></p>
      </Card.Text>
    </Card.Body>
    <Card.Footer>
